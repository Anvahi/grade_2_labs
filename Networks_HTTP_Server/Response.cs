    ...
    class Response {
        ...
        public static Response From(Request request) {
            ...
            if (request.Type == "GET") {
                ...
                if (request.Url.Equals("/error"))
                    return NotWork("507.html", "507 Insufficient Storage");
                ...
                if (fi.Exists && fi.Extension.Contains(".")) {
                    ...
                    foreach (FileInfo ff in files) {
                        if (ff.Name.Contains("test.html") || ff.Name.Contains("khomenkova.html"))
        ...
        private static Response MakeFromFile(FileInfo f) {
            ...
            BinaryReader reader = new BinaryReader(stream);
            reader.Read(b, 0, b.Length);
            return new Response("200 OK", "text", b);
        }
        ...
        private static Response NotWork(String fileName, String status) {
            ...
            return new Response(status, "text", d);
        }
